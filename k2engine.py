...
class Engine:
	...
	self.verbose = True # temporarily Debugging function activation
...
class EngineInstance:
    ...
    def scan(self, filename, *callback):
        import kernel
	total_file = os.listdir(filename)
        ...
        while len(file_scan_list):
		    ...
		    total_count = len(total_file)
		    print str(self.result['Files'])+'   out of   '+str(total_count)
